...
function scrollHeader() {
    ...
    if(this.scollY >= 50) header.classList.add("scroll-header"); else header.classList.remove("scroll-header")
}
...
sr.reveal(`.category_data, .max_content, .footer_content`,{internal: 100})
